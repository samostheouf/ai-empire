...
const EMAIL_COPY: Record<string, {
  ...
  fr: { orderSubject: '✅ Confirmation — ', orderConfirmation: 'Confirmation de commande', paymentConfirmed: '✅ Paiement confirmé', download: '📥 Télécharger le template', thanks: 'Merci pour votre achat !', contactUs: 'samilaboulette21@gmail.com', apiKeySubject: '🔑 Votre clé API NeuraAPI', apiKeyTitle: '🔑 Votre clé API', welcome: 'Bienvenue !', apiKeyDesc: 'Voici votre clé API pour accéder aux services NeuraAPI :', plan: 'Plan', credits: 'Crédits', docs: '📖 Voir la documentation', keepSafe: 'Conservez cette clé en lieu sûr.' },
  en: { orderSubject: '✅ Order Confirmed — ', orderConfirmation: 'Order Confirmation', paymentConfirmed: '✅ Payment Confirmed', download: '📥 Download Template', thanks: 'Thank you for your purchase!', contactUs: 'samilaboulette21@gmail.com', apiKeySubject: '🔑 Your NeuraAPI Key', apiKeyTitle: '🔑 Your API Key', welcome: 'Welcome!', apiKeyDesc: 'Here is your API key to access NeuraAPI services:', plan: 'Plan', credits: 'Credits', docs: '📖 View Documentation', keepSafe: 'Keep this key safe.' },
  es: { orderSubject: '✅ Pedido Confirmado — ', orderConfirmation: 'Confirmación de Pedido', paymentConfirmed: '✅ Pago Confirmado', download: '📥 Descargar Plantilla', thanks: '¡Gracias por tu compra!', contactUs: 'samilaboulette21@gmail.com', apiKeySubject: '🔑 Tu Clave API NeuraAPI', apiKeyTitle: '🔑 Tu Clave API', welcome: '¡Bienvenido!', apiKeyDesc: 'Aquí está tu clave API para acceder a los servicios de NeuraAPI:', plan: 'Plan', credits: 'Créditos', docs: '📖 Ver Documentación', keepSafe: 'Guarda esta clave en un lugar seguro.' },
  de: { orderSubject: '✅ Bestellung Bestätigt — ', orderConfirmation: 'Bestellbestätigung', paymentConfirmed: '✅ Zahlung Bestätigt', download: '📥 Template Herunterladen', thanks: 'Danke für deinen Kauf!', contactUs: 'samilaboulette21@gmail.com', apiKeySubject: '🔑 Dein NeuraAPI Schlüssel', apiKeyTitle: '🔑 Dein API Schlüssel', welcome: 'Willkommen!', apiKeyDesc: 'Hier ist dein API-Schlüssel:', plan: 'Plan', credits: 'Guthaben', docs: '📖 Dokumentation Ansehen', keepSafe: 'Bewahre diesen Schlüssel sicher auf.' },
  it: { orderSubject: '✅ Ordine Confermato — ', orderConfirmation: 'Conferma Ordine', paymentConfirmed: '✅ Pagamento Confermato', download: '📥 Scarica Template', thanks: 'Grazie per il tuo acquisto!', contactUs: 'samilaboulette21@gmail.com', apiKeySubject: '🔑 La Tua Chiave NeuraAPI', apiKeyTitle: '🔑 La Tua Chiave API', welcome: 'Benvenuto!', apiKeyDesc: 'Ecco la tua chiave API:', plan: 'Piano', credits: 'Crediti', docs: '📖 Vedi Documentazione', keepSafe: 'Conserva questa chiave in un posto sicuro.' },
  pt: { orderSubject: '✅ Pedido Confirmado — ', orderConfirmation: 'Confirmação de Pedido', paymentConfirmed: '✅ Pagamento Confirmado', download: '📥 Baixar Template', thanks: 'Obrigado pela sua compra!', contactUs: 'samilaboulette21@gmail.com', apiKeySubject: '🔑 Sua Chave NeuraAPI', apiKeyTitle: '🔑 Sua Chave API', welcome: 'Bem-vindo!', apiKeyDesc: 'Aqui está sua chave API:', plan: 'Plano', credits: 'Créditos', docs: '📖 Ver Documentação', keepSafe: 'Guarde esta chave em local seguro.' },
  ja: { orderSubject: '✅ ご注文確認 — ', orderConfirmation: '注文確認', paymentConfirmed: '✅ お支払い確認', download: '📥 テンプレートをダウンロード', thanks: 'ご購入ありがとうございます！', contactUs: 'samilaboulette21@gmail.com', apiKeySubject: '🔑 NeuraAPI APIキー', apiKeyTitle: '🔑 APIキー', welcome: 'ようこそ！', apiKeyDesc: 'NeuraAPIサービスにアクセスするためのAPIキーです：', plan: 'プラン', credits: 'クレジット', docs: '📖 ドキュメントを見る', keepSafe: 'このキーは安全な場所に保管してください。' },
  ko: { orderSubject: '✅ 주문 확인 — ', orderConfirmation: '주문 확인', paymentConfirmed: '✅ 결제 확인', download: '📥 템플릿 다운로드', thanks: '구매해 주셔서 감사합니다!', contactUs: 'samilaboulette21@gmail.com', apiKeySubject: '🔑 NeuraAPI API 키', apiKeyTitle: '🔑 API 키', welcome: '환영합니다!', apiKeyDesc: 'NeuraAPI 서비스에 접근하기 위한 API 키입니다:', plan: '플랜', credits: '크레딧', docs: '📖 문서 보기', keepSafe: '이 키를 안전한 곳에 보관하세요.' },
  zh: { orderSubject: '✅ 订单确认 — ', orderConfirmation: '订单确认', paymentConfirmed: '✅ 付款确认', download: '📥 下载模板', thanks: '感谢您的购买！', contactUs: 'samilaboulette21@gmail.com', apiKeySubject: '🔑 您的 NeuraAPI 密钥', apiKeyTitle: '🔑 API 密钥', welcome: '欢迎！', apiKeyDesc: '这是您访问 NeuraAPI 服务的 API 密钥：', plan: '套餐', credits: '积分', docs: '📖 查看文档', keepSafe: '请妥善保管此密钥。' },
  ar: { orderSubject: '✅ تأكيد الطلب — ', orderConfirmation: 'تأكيد الطلب', paymentConfirmed: '✅ تأكيد الدفع', download: '📥 تحميل القالب', thanks: 'شكراً لك على الشراء!', contactUs: 'samilaboulette21@gmail.com', apiKeySubject: '🔑 مفتاح NeuraAPI الخاص بك', apiKeyTitle: '🔑 مفتاح API', welcome: 'مرحباً!', apiKeyDesc: 'إليك مفتاح API للوصول إلى خدمات NeuraAPI:', plan: 'الخطة', credits: 'الرصيد', docs: '📖 عرض التوثيق', keepSafe: 'احفظ هذا المفتاح في مكان آمن.' },
};
