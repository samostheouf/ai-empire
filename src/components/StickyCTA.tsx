...
export default function StickyCTA() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 animate-slide-up md:hidden">
      <div className="bg-indigo-950/98 backdrop-blur-xl border-t border-indigo-700/50 shadow-2xl shadow-indigo-500/20">
        <div className="flex items-center gap-3 px-4 py-3">
          ...
          <Link
            ...
            className="flex-shrink-0 rounded-lg bg-gradient-to-r from-indigo-600 to-purple-600 px-4 py-2.5 text-xs font-semibold text-white shadow-lg shadow-indigo-500/25 flex items-center gap-1.5"
          >
            {t('stickyStart')}
          ...
          <button
            ...
            className="flex-shrink-0 p-1.5 rounded-lg text-indigo-400 hover:text-white hover:bg-indigo-800/50 transition-colors"
