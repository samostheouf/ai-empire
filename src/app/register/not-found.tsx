...
export default function RegisterNotFound() {
  ...
  const SUGGESTED_LINKS = [
    { name: t('notFoundLogin'), href: '/login', desc: t('notFoundLoginDesc2') },
  ...
  return (
    <div className="bg-[#0f0a2e] min-h-screen flex items-center justify-center px-4">
      <div className="text-center max-w-lg">
        ...
        <h1 className="mt-6 text-3xl font-bold text-white">{t('notFoundRegisterTitle')}</h1>
        <p className="mt-4 text-indigo-300">{t('notFoundRegisterDesc')}</p>
        ...
        <div className="mt-8 flex items-center justify-center gap-4">
          <Link href="/register" className="flex items-center gap-2 rounded-lg bg-indigo-600 px-6 py-3 font-semibold text-white hover:bg-indigo-500 transition-colors">
