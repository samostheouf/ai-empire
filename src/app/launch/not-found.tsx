...
export default function LaunchNotFound() {
  ...
  const SUGGESTED_LINKS = [
    { name: t('notFoundHome'), href: '/', desc: t('notFoundLoginDesc2') },
    ...
    <div className="bg-indigo-950 min-h-screen flex items-center justify-center px-4">
      <div className="text-center max-w-lg">
        ...
        <div className="mt-8 flex items-center justify-center gap-4">
          <Link href="/" className="flex items-center gap-2 rounded-lg bg-orange-500 px-6 py-3 font-semibold text-white hover:bg-orange-400 transition-colors">
