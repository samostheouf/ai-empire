          ...
          <section className="rounded-2xl border border-indigo-800/50 bg-indigo-900/30 p-8">
            ...
            <div className="space-y-3 text-indigo-200">
              <div className="flex items-center gap-3">
                ...
                <p><span className="font-semibold text-white">Email:</span> <a href="mailto:samilaboulette21@gmail.com" className="text-indigo-400 hover:text-white transition-colors">samilaboulette21@gmail.com</a></p>
              </div>
              <div className="flex items-center gap-3">
