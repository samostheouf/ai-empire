        ...
        <div className="space-y-12">
          ...
          <section className="rounded-2xl border border-indigo-800/50 bg-indigo-900/30 p-8">
            ...
            <div className="space-y-3 text-indigo-200 text-sm">
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li>Correo electrónico: <a href="mailto:samilaboulette21@gmail.com" className="text-indigo-400 hover:text-white transition-colors">samilaboulette21@gmail.com</a></li>
                <li>DPD: <a href="mailto:samilaboulette21@gmail.com" className="text-indigo-400 hover:text-white transition-colors">samilaboulette21@gmail.com</a></li>
              </ul>
              <p className="mt-4">
