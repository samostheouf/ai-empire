...
export default function LoginNotFound() {
  ...
  const SUGGESTED_LINKS = [
    { name: t('notFoundRegister'), href: '/register', desc: t('notFoundRegisterDesc2') },
  ...
  return (
    <div className="bg-[#0f0a2e] min-h-screen flex items-center justify-center px-4">
      <div className="text-center max-w-lg">
        ...
        <h1 className="mt-6 text-3xl font-bold text-white">{t('notFoundLoginTitle')}</h1>
        <p className="mt-4 text-indigo-300">{t('notFoundLoginDesc')}</p>
        ...
        <div className="mt-8 flex items-center justify-center gap-4">
          <Link href="/login" className="flex items-center gap-2 rounded-lg bg-indigo-600 px-6 py-3 font-semibold text-white hover:bg-indigo-500 transition-colors">
